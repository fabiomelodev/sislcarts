<x-layout.base>
    <x-slot name="title">Características de Produtos</x-slot>
        ...
        <div class="container flex justify-center">
            ...
            <div class="lg:w-8/12">
                ...
                <div class="border shadow-lg rounded-lg bg-gray-100 p-4">
                    ...
                    <div class="mt-6">
                        <form action="{{ route('product-feature.store') }}" method="POST">
                            @csrf
