        ...
        <div class="container flex justify-center">
            ...
            <div class="lg:w-8/12">
                ...
                <div class="border shadow-lg rounded-lg bg-gray-100 p-4">
                    ...
                    <div class="mt-6">
                        <form action="{{ route('type-service.update', $typeService->id) }}" method="POST">
                            @method('PUT')
                            @csrf
                            ...
                            <div class="flex flex-wrap gap-4">
                                ...
                                <div class="w-full flex flex-col gap-1">
                                    <livewire:form.select-field label="Status" name="status" :options="\App\Enums\Status::values()" value="{{ $typeService->status_value }}" />
                                </div>
